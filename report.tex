...
\newlength{\SignatureDateWidth}
\settowidth{\SignatureDateWidth}{«\underline{\hspace{0.7cm}}» \underline{\hspace{2cm}}}
\newcommand{\SignatureDateSlot}{«\underline{\hspace{0.7cm}}» \underline{\hspace{2cm}} \ReportYear{} г.}
...
\centering
{\Large\textit{Решить систему линейных уравнений \(AX=B\) с точностью до \(0{,}01\) методом простой итерации}}
\end{minipage}
...
Выполнил:\\
\underline{\hspace{\SignatureDateWidth}} \StudentName\\
\SignatureDateSlot
\end{minipage}%
\bigskip
...
\hfill\begin{minipage}{0.5\textwidth}
Руководитель:\\
\underline{\hspace{\SignatureDateWidth}} \SupervisorName\\
\SignatureDateSlot
\end{minipage}%
